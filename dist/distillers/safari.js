...
ReaderArticleFinder = function(e) {
    ...
    articleTitleInformation: function() {
        ...
        if (this.articleNode()) {
            ...
            var A = "h1, h2, h3, h4, h5, a, p, div, span",
            ...
            for (var R = M.querySelectorAll("a"), C = 0, F = R.length; C < F; ++C) {
                var P = R[C];
    ...
    findArticleBylineElementWithoutRejection: function() {
        ...
        const t = "[itemprop='author'], a[rel='author']",
            n = ".byline, .article-byline, .entry-meta, .author-name, .byline-dateline, .article-author, [itemprop='author'], a[rel='author']";
        var i,
            r,
            a,
